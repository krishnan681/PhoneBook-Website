  ...
  return (
    ...
    >
      ...
      <ul>
        ...
        <li>
          Messages can be on Clearance Sales, New Introductions, Special Offers
          for the Day, Invitations, Change of Address, Shifting, Business
          Enquiries, Reminders
        </li>
        ...
        <li>
          Specialty Reach: Find all the Prospects of a specific Category in a
          City and reach them.
        </li>
      </ul>
      ...
      <p style={{ textAlign: "center" }}>
        Scan QR Code or Visit <strong>www.signpostphonebook.in</strong>
      </p>
