...
import NavPage from "../Components/Admin/NavPage"; // Import NavPage component
...
export default function Navigationpage() {
  ...
  // List of routes where NavPage should replace Navigationpage
  const alternateRoutes = ["/datas", "/team", "/chat"];
  const isAlternateRoute = alternateRoutes.includes(location.pathname);

  // Conditionally render either Navigationpage or NavPage
  if (isAlternateRoute) {
    return <NavPage />;
  }

  const adminNumbers = ["9843657564", "8344508070", "6383965890"];
  const isAdminUser = adminNumbers.includes(userData?.mobileno);

  // Hide navbar on /AdminPage
